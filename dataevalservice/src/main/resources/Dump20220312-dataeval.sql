...
--
-- Table structure for table `PATIENT_CALL_RECORD`
--

DROP TABLE IF EXISTS `PATIENT_CALL_RECORD`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PATIENT_CALL_RECORD` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `PATIENT_ID` int(11) DEFAULT NULL,
  `VISIT_DATE` date DEFAULT NULL,
  `CALL_RECORD_STATUS` varchar(45) DEFAULT NULL,
  `PATIENT_STATUS` varchar(45) DEFAULT NULL,
  `CREATION_DATE` datetime DEFAULT NULL,
  `CREATED_BY` varchar(45) DEFAULT NULL,
  `UPDATED_DATE` datetime DEFAULT NULL,
  `CALL_TYPE` varchar(45) DEFAULT NULL,
  `CARE_TEAM_MEMBER_FIRST_NAME` varchar(45) DEFAULT NULL,
  `CARE_TEAM_MEMBER_LAST_NAME` varchar(45) DEFAULT NULL,
  `SIGNATURE` varchar(45) DEFAULT NULL,
  `NEXT_MONTH_APPOINTMENT_DATE` datetime DEFAULT NULL,
  `ADDITIONAL_NOTES` varchar(2000) DEFAULT NULL,
  `MANAGING_SYMPTOMS` varchar(2000) DEFAULT NULL,
  `MEASURABLE_TREATMENT_OUTCOME` varchar(2000) DEFAULT NULL,
  `HEALTH_CONDITIONS_TO_DISCUSS` varchar(2000) DEFAULT NULL,
  `REMAINING_TIME` int(11) DEFAULT NULL,
  `TIME_SPENT_IN_SESSION` int(11) DEFAULT NULL,
  `UPDATED_BY` varchar(45) DEFAULT NULL,
  `TOTAL_TIME_SPENT` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `PATIENT_ID_KEY_idx` (`PATIENT_ID`),
  CONSTRAINT `PATIENT_ID_KEY` FOREIGN KEY (`PATIENT_ID`) REFERENCES `USER` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf32;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `PATIENT_CALL_RECORD`
--

LOCK TABLES `PATIENT_CALL_RECORD` WRITE;
/*!40000 ALTER TABLE `PATIENT_CALL_RECORD` DISABLE KEYS */;
INSERT INTO `PATIENT_CALL_RECORD` VALUES (58,16,'2022-03-12','INACTIVE','ACTIVE','2022-03-12 08:39:10','ADMIN','2022-03-12 10:07:12','Inbound','Admin','Admin',NULL,'2022-03-17 14:09:00','fasd','fasdf','fasd','fasd',1193,7,'ADMIN',7),(59,16,'2022-03-12','ACTIVE','ACTIVE','2022-03-12 10:07:12','ADMIN','2022-03-12 10:07:12','Inbound','Admin','Admin',NULL,'2022-03-28 18:40:00','UPdate Call Record','UPdate Call Record','UPdate Call Record','UPdate Call Record',1176,17,'ADMIN',24),(60,17,'2022-03-12','ACTIVE','ACTIVE','2022-03-12 10:09:39','ADMIN','2022-03-12 10:09:39','Inbound','Admin','Admin',NULL,'2022-03-21 15:39:00','Health COnfition','Health COnfition','Health COnfition','Health COnfition',1187,13,'ADMIN',13),(61,14,'2022-03-12','INACTIVE','ACTIVE','2022-03-12 10:46:28','ADMIN','2022-03-12 15:18:28','Inbound','Admin','Admin',NULL,'2022-03-19 16:16:00','TEst','Test','Test','Test',1191,9,'ADMIN',9),(62,14,'2022-03-12','INACTIVE','ACTIVE','2022-03-12 15:18:28','ADMIN','2022-03-12 15:35:38','Inbound','Admin','Admin',NULL,'2022-03-30 13:53:00','fasd','fads','fasd','fasd',1182,9,'ADMIN',18),(63,14,'2022-03-12','ACTIVE','ACTIVE','2022-03-12 15:35:38','ADMIN','2022-03-12 15:35:38','Inbound','Admin','Admin',NULL,'2022-03-23 13:09:00','fads','fads','fasd','fasdf',1170,12,'ADMIN',30);
/*!40000 ALTER TABLE `PATIENT_CALL_RECORD` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `USER` (
  ...
  `UPDATED_BY` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `Test_idx` (`ROLE_ID`),
  CONSTRAINT `Test` FOREIGN KEY (`ROLE_ID`) REFERENCES `ROLES` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `USER` VALUES (1,'admin','Admin','Admin',NULL,'$2a$10$rFxO5wvbWpLTA2gUL0hiVenUyx38ETGvFAhieyV3bbZYbzMmvKDlS','Active',1,'2022-03-11 18:18:30','ADMIN','2022-03-12 16:33:49','ADMIN'),(2,'Nurse','Nurse','Nurse',NULL,'$2a$10$tnHNl//LcKS4MEyECc0Tr.nVmBB7S.jKde7QnymLKXsCGhvbqy81.','Active',3,'2022-03-11 18:18:45',NULL,NULL,NULL),(3,'Doctor','Doctor','Doctor',NULL,'$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',4,'2022-03-11 12:18:45',NULL,NULL,NULL),(4,'Biller','Biller Name','Biller Last Name',NULL,'$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',5,'2022-03-11 18:18:45',NULL,NULL,NULL),(5,'patient','Test Patient1','Patient',NULL,'$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,'2022-03-11 18:18:45',NULL,NULL,NULL),(14,'Priyakna@gmail.com','Priyanka','Gundawar','1991-08-03','$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,'2022-03-11 18:18:45',NULL,NULL,NULL),(15,'sairam','Sai Ram','Dikondawar',NULL,'$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,'2022-03-11 18:18:45',NULL,NULL,NULL),(16,'akhilesh@gmail.com','Akhilesh','Bashettiwar','2021-12-09','$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,'2022-03-11 18:10:45',NULL,NULL,NULL),(17,'Pradeep@gmail.com','Pradeep','Palakurthi','1978-01-11','$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,'2022-03-11 18:18:45',NULL,NULL,NULL),(18,'Praveen@gmail.com','praveen ','katkam-u','1992-05-14','$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,'2022-03-12 10:37:58','admin','2022-03-12 10:37:58','ADMIN'),(19,'Test User Name','Test User Name','Test User Name',NULL,'$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,NULL,'admin',NULL,'admin'),(20,'Testing New User','Testing New User','Testing New User',NULL,'$2a$10$Iem0Lf7huYWkYtbI8F/NiO1rpGQRZzDKgdBDsxzdK9TkAKiDNPgSm','Active',2,'2022-03-12 10:38:57','ADMIN','2022-03-12 10:38:57','ADMIN');
...
-- Dump completed on 2022-03-12 23:38:11
